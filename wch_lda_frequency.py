...
# The topics function includes preprocessing and the LDA model
# and returns the topics and visulizations.
# Number of topics and year range can be defined (all records are within 1157-2020) 
...
# The keyword_frequency function counts keyword frequencies by year
# Define the keyword and see how its frequency change over time
...
def keyword_frequency(keyword: str):
    ...
    # Aggregate keyword frequencies by decade
    # focusing on 1850-2000 for now
    ...
    return line_kw # keyword frequencies aggregated by decade
...
# Plot keyword frequencies line chart over time.
# Multiple words are plotted in one graph to compare related terms in context
# but no specific relationships should be assumed 

dict_lines = {
    
    # terms related to minorities
    ...
    # terms related to resistance & rebellion
