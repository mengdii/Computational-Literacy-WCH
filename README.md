...
I plotted multiple keywords in one chart to see if they might reveal any interesting patterns, such as women, miners, students, black, which could be considered as communities or minorities who have made specific contributions to the working class history; or strike, protest, movement, union which could be related to resistance and rebellion. But at this point we shouldn’t assume the statistics of these concepts have any specific relationships with each other.
